...
public class TypeHelperTests
{
  ...
  public void FindBaseTypes_WithNonGeneric()
  {
    ...
    Assert.Equal(types, [typeof(IMessage)]);
  ...
  public void FindBaseTypes_WithGeneric()
  {
    ...
    Assert.Equal(types, [typeof(IMessage<string>)]);
    ...
    Assert.Equal(types, [typeof(Message<string>)]);
    ...
    Assert.Equal(types, [typeof(IMessage<string>), typeof(IMessage<int>)]);
    
    types = TypeHelper.FindTypes(typeof(ClassWithGenericMultipleInterface), typeof(IMessage<int>));
    Assert.Equal(types, [typeof(IMessage<int>)]);
